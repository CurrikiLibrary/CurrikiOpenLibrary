...
<h1>Resource</h1>
<form action="admin.php?page=curriki_file_check_list&time=<?php echo time();?>" method="post">
    ...
    <table >
        ...
        <tr>
            ...
            <td><textarea disabled="disabled" style="height: 200px; "><?php echo $data[0]->content; ?></textarea></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="text-align: right">
                <input type="button" value="Cancel" onclick="window.location.href='admin.php?page=curriki_file_check_list&time=<?php echo time();?>'" />
