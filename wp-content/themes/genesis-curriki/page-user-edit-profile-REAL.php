                ...
                <div class="edit-section">                    
                    ...
                    <div class="edit-profile-image">
                        <?php if($me->uniqueavatarfile){?>
                            <img class="circle border-grey profile-img" src="https://<?php echo DBI_AWS_S3_CDN_URL; ?>/avatars/<?php echo $me->uniqueavatarfile ?>" alt="member-name" width="150" />
                        <?php }else{
                                $profile = get_user_meta(get_current_user_id(),"profile",true);    
                                $profile = isset($profile) ? json_decode($profile) : null; 
...
<!--                    <div>
                    ...
                    <div class="edit-name-social">
                        <div class="edit-name">
                            ...
                            <span class="occupation">
                                <select name="membertype">
                                    ...
                                    <option value="School/District Administrator"<?php if($me->membertype == 'School/District Administrator')echo ' selected="selected"'; ?>><?php echo __('School/District Administrator','curriki'); ?></option>
                                    <option value="Non-profit Organization"<?php if($me->membertype == 'Non-profit Organization')echo ' selected="selected"'; ?>><?php echo __('Non-profit Organization','curriki'); ?></option>
                                </select>
                                ...
                                <input type="text" id="state_text" name="state" value="<?php echo $me->state; ?>" placeholder="<?php echo __('State','curriki'); ?>"<?php if(strtoupper($me->country) == 'US' or strtoupper($me->country) == '')echo ' disabled="disabled" style="display:none;"';?> />
                        ...
                        <div class="edit-social share-icons">
                            ...
                            <input type="text" name="user_email" placeholder="<?php echo __('Email','curriki'); ?>" value="<?php echo $wpdb->get_var("SELECT user_email FROM cur_users where ID='".get_current_user_id()."'"); ?>" />
                        </div>
