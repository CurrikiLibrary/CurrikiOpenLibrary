...
class search {
    ...
    public function curriki_search_api20_init() {
        ...
        $this->awsSearchEndPoint = AWS_CLOUDSEARCH_END_POINT . '/2013-01-01/search?q.parser=lucene&q.options={defaultOperator: \'or\'}&q=';
    ...
    public function curriki_search_api20_make_topofsearch_query() {
        ...
        //Query Parameters
//        $this->awsSearchEndPoint = AWS_CLOUDSEARCH_END_POINT . '/2013-01-01/search?q.parser=lucene&q.options={fields: [\'title^8\',\'keywords^2\', \'site^0.5\', \'subjectarea^0.5\', \'instructiontype^0.5\', \'subject^0.5\', \'license^0.5\', \'educationlevel^0.5\', \'access^0.5\', \'reviewstatus^0.5\', \'subsubjectarea^0.5\', \'type^0.5\', \'currikilicense^0.5\', \'description^0.5\', \'firstname^0.5\', \'lastname^0.5\', \'mediatype^0.5\', \'standard^0.5\', \'active^0.5\', \'generatedkeywords^0.5\', \'aligned^0.5\', \'language^0.5\', \'url^0.5\', \'topofsearch^0.5\', \'fullname^0.5\', \'filecontent^0.5\',\'content^0.5\'],defaultOperator: \'or\'}&q=';
        $this->awsSearchEndPoint = AWS_CLOUDSEARCH_END_POINT . '/2013-01-01/search?q.parser=lucene&q.options={fields: [\'title^4\', \'description^2.5\',\'keywords^3\', \'filecontent^1\',\'content^1\'],defaultOperator: \'or\'}&q=';
        $this->query = $this->awsSearchEndPoint;
        $this->query .= "(";
//        $this->query .= " (active:\"T\")";
        
        if($this->request['type'] == 'Resource'){
            $this->query .= '(active:"T") AND (hascommunity:1) AND (((resourcetype:"collection") AND NOT title:"Favorites") OR resourcetype:"resource") ';
            if (isset($this->request['query']) && !empty($this->request['query'])){
...
//                    }
//                }
                if(isset($this->request['communityid'])){
                    $this->query .= " AND (communityid:\"".$this->request['communityid']."\")";
                }
            }
        } else {
            $this->query .= " (active:\"T\")";
            $this->query .= " (hascommunity:\"1\")";
//            $this->query .= " NOT title:\"Favorites\"";
            $this->query .= " AND ( type:\"" . $this->request['type'] . "\" )";
        }
        // Only show studentfacing = T when subdomain is studentsearch
        if($this->branding == 'studentsearch' || $this->branding == 'students'):
            $this->query .= " AND studentfacing:\"T\"";
...
//            }
    ...
    public function curriki_search_page_scripts() {
        ...
        wp_enqueue_style('search-module-css', get_stylesheet_directory_uri() . '/modules/community-pages-search/css/style.css', null, false, 'all');
        
        
        wp_register_script('search-module-script',get_stylesheet_directory_uri() . '/modules/community-pages-search/js/script.js', array('jquery'), false, true);
        ...
        //wp_enqueue_script('search-module-script', get_stylesheet_directory_uri() . '/modules/community-pages-search/js/script.js', array('jquery'), false, true);
    ...
    public function curriki_search_page_header() {
        get_template_part('modules/community-pages-search/brandings/' . $this->branding . '/header');
    }
...
//                echo "<pre>";
//                print_r($this->branding);
//                var_dump($this->branding != 'search' || $this->branding != 'studentsearch' || $this->branding != 'students');
//                die();
//            endif;

                    ?>
                    <?php if ($this->branding != 'search' && $this->branding != 'studentsearch' && $this->branding != 'students') get_template_part('modules/community-pages-search/views/search_title_widget'); ?>
                    <?php if (!(isset($this->request['phrase']) && $this->status['found'])) get_template_part('modules/community-pages-search/brandings/' . $this->branding . '/text_under_search'); ?>
                    <?php if (isset($this->request['phrase'])) { ?>
                        <?php get_template_part('modules/community-pages-search/views/search_results_header'); ?>
                        <?php if ($this->request['type'] == 'Resource') get_template_part('modules/community-pages-search/views/search_result_resources'); ?>
                        <?php if($this->partnerid!=3){ ?>
                            <?php if (isset($this->request['phrase']) && $this->status['found'] > $this->request['size']) get_template_part('modules/community-pages-search/views/pagination'); ?>
                        <?php } ?>
                    <?php } ?>
    ...
    public function curriki_search_page_footer() {
        get_template_part('modules/community-pages-search/brandings/' . $this->branding . '/footer');
    }
...
//        $_GET['getquery']=1;
    ...
    public function curriki_search_targeted_body() {
        ...
        <div class="search-content" >
            <div class="wrap container_12" >
                <?php get_template_part('modules/community-pages-search/views/search_title_widget'); ?>
                <?php $this->curriki_search_targeted_resources(); ?>
                <?php get_template_part('modules/community-pages-search/views/search_result_resources'); ?>
