...
//  wp_enqueue_style('bootstrap-css', get_stylesheet_directory_uri() . '/css/questions/bootstrap.css');
  ...
  wp_enqueue_script('bootstrap-js', get_stylesheet_directory_uri() . '/js/home-page/bootstrap.min.js', 'jquery', '2.1.5');
  ...
  wp_enqueue_style('home-page-css', get_stylesheet_directory_uri() . '/css/home-page/new.css');
  ?>
...
function curriki_home_body_blocks() {
	...
	echo '<div class="site-alert alert">';
		echo '<div class="wrap">';
			echo '<button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">×</span></button>';
			echo 'Impacted by school closures? We can help. Get help <a href="https://www2.curriki.org" target="_blank">here</a>.';
		echo '</div>';
	echo '</div>';
	...
	echo '<div class="home-row search-row">';
		...
		echo '<div class="wrap container_12">';
			echo '<div class="search-modal">';
				echo '<h2><span>FIND YOUR LESSON</span> <br> A Community for Teaching and Learning <br> Share and
				...
				echo '<div class="text-center buttons">';
					...
					echo '<a href="#info-content-v2" class="btn btn-dark-blue btn-play-icon scrollToSection">';
						echo '<i class="fa fa-arrow-circle-down"></i> A Sneak Peak at What\'s New!';
					echo '</a>';
					echo '<a href="https://learneverywhere.org/" target="_new" class="btn btn-dark-blue btn-play-icon">';
						echo '<i class="fa fa-paper-plane"></i> Visit #learneverywhere';
					echo '</a>';
				echo '</div>';
			echo '</div>';
		echo '</div>';
	...
	*/
	...
	<div class="home-row row-info">
		<div class="wrap container_12">
			...
			<div class="clearfix no-gutters">
				...
				<div class="col-sm-4">
					<a class="level-box" href="{$search_url}&subject%5B2%5D=CareerTechnicalEducation">
	...
	<div class="home-row row-info-content-v2" id="info-content-v2">
		<div class="wrap container_12">
			<div class="text-center margin-bottom-65">
				<h2 class="heading-v3">A Sneak Peak at What's New!</h2>
			</div>
			<div class="row">
				<div class="col-sm-4">
					<div class="info-box text-center">
						<span class="image-box">
							<img class="img-fluid" src="{$theme_url}/images/home-page/homepage.jpg" width="456" height="332" alt="Homepage">
						</span>
						<div class="info-text">
				...
				<div class="col-sm-4">
					<div class="info-box text-center">
						...
						<span class="image-box">
							<img class="img-fluid" src="{$theme_url}/images/home-page/dashboard.jpg" width="456" height="332" alt="Dashboard">
						</span>
					</div>
				</div>
				<div class="col-sm-4">
					<div class="info-box text-center">
						<span class="image-box">
							<img class="img-fluid" src="{$theme_url}/images/home-page/search_result.jpg" width="456" height="332" alt="Search Result">
						</span>
		...
		<div class="wrap container_12">
			<div class="row">
				<div class="col-sm-8 col-sm-offset-2">
					<div class="text-center info-text-v3">
						<h2>New Student CTE Series on Electronics</h2>
			...
			<div class="text-center">
				<span class="image-box no-shadow">
					<img class="img-fluid image-hide-mobile" src="{$theme_url}/images/home-page/resource_and_collection.png" width="1414" height="540" alt="CTE Series on Electronics">
					<img class="img-fluid image-hide-desktop" src="{$theme_url}/images/home-page/resource_and_collection_mobile.jpg" width="456" height="335" alt="CTE Series on Electronics">
				</span>
			</div>
		</div>
	</div>
		...
		<div class="wrap container_12">
			<div class="grid_7">
				...
				<div class="button-group">
					<a class="btn btn-dark-blue btn-with-icon btn-icon-right" href="{$home_url}/about-curriki/donate/">Make a Donation <i
					class="fa fa-angle-right"></i></a>
					<a class="btn btn-dark-blue btn-with-icon btn-icon-right" href="{$home_url}/about-curriki/partners-sponsors/">Partner with
