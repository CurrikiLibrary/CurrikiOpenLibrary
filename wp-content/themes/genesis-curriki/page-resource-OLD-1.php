...
function curriki_AddShareMeta() {
  if (isset($_GET['rid']) || isset($_GET['pageurl'])) {
    ...
    if (trim($resourceUser['uniqueavatarfile']) != '')
      $imageUrl = 'https://' . DBI_AWS_S3_CDN_URL . '//avatars/' . $resourceUser['uniqueavatarfile'];
    else
...
function curriki_resource_page_scripts() {
  ...
  wp_enqueue_style('resource-font-awesome-css', 'http://maxcdn.bootstrapcdn.com/font-awesome/4.3.0/css/font-awesome.min.css');
  wp_enqueue_style('resource-legacy-css', get_stylesheet_directory_uri() . '/css/legacy.css');

  wp_enqueue_style('jquery-fancybox-css', get_stylesheet_directory_uri() . '/fancybox/source/jquery.fancybox.css?v=2.1.5');
  wp_enqueue_script('jquery-fancybox-js', get_stylesheet_directory_uri() . '/fancybox/source/jquery.fancybox.pack.js?v=2.1.5', 'jquery.fancybox', '2.1.5');
  wp_enqueue_script('jquery-mousewheel-js', get_stylesheet_directory_uri() . '/fancybox/source/jquery.mousewheel-3.0.6.pack.js', 'jquery.mousewheel', '3.0.6');
  ...
  wp_enqueue_style('qtip', get_stylesheet_directory_uri() . '/js/qtip/jquery.qtip.min.css', null, false, false);
  wp_enqueue_script('qtip', get_stylesheet_directory_uri() . '/js/qtip/jquery.qtip.min.js', array('jquery'), false, true); 
  ...
  <?php
  if (isset($_GET['viewer']) && trim($_GET['viewer']) == 'embed') {
    echo '.page-header {background: none;padding: 20px 0 20px 0;}';
    echo 'body.backend {background: #BCBEC0; }';
    echo '.site-container {border: 10px solid #031770; padding: 0; max-width: 680px; padding: 10px;}';
    echo '.resource-content-content:nth(1) { border: 5px solid #99C736; }';
    echo '.resource-header-info{width: 100%;}';
    echo 'a#powered-by-curriki {background: url(http://static-cdn.curriki.org/prod/1.14.e443/xwiki/skins/curriki8/images/curriki-logo-embed.gif) top left no-repeat;display: inline;float: right;margin-right: 10px;height: 50px;text-indent: -9999px;width: 108px;}';
...
function curriki_resource_header() {
  ...
  if (!isset($_GET['viewer'])) {
    $resource_header .= '<div class="resource-link page-link"><strong>Website Address:</strong> <a class="resource-url-link" href="' . get_bloginfo('url') . '/oer/' . $resourceUser['pageurl'] . '">' . get_bloginfo('url') . '/oer/' . $resourceUser['pageurl'] . '</a></div>';
  ...
  if (trim($resourceUser['uniquename']) != '')
    $resource_header .= '<a href="#" class="share-download" onclick="resourceFileDownload(' . $resourceUser['fileid'] . ', \'https://' . DBI_AWS_S3_CDN_URL . '//resourcefiles/' . $resourceUser['uniquename'] . '\')"><span class="fa fa-download"></span></a>';
  ...
  if (trim($resourceUser['uniqueavatarfile']) != '')
    $resource_header .= '<img class="border-grey circle" src="https://' . DBI_AWS_S3_CDN_URL . '//avatars/' . $resourceUser['uniqueavatarfile'] . '" alt="member-name" />';
  else
  ...
  $resource_header .= '<div class="author"><span class="member-name name">' . '<a href="' . $user_page_url . '">' . $resourceUser['display_name'] . '</a>' . '</span><span class="occupation">' . $resourceUser['organization'] . '</span><span class="location">' . $location . '</span></div>';
  ...
  if (!isset($_GET['viewer'])) {
    ...
    $qtip_text = "";
    if ($resourceUser['reviewstatus'] == 'reviewed' && $resourceUser['reviewrating'] != null && $resourceUser['reviewrating'] >= 0) {
        
        if(is_resource_rating_new_scale($resourceUser))
        {
            $qtip_text = '<div class="hidden-qtip">On a scale of 0 to 5</div>';
        }else{
            $qtip_text = '<div class="hidden-qtip">On a scale of 0 to 3</div>';                        
        }
                
        $resource_header .= '<div class="resource-header-curriki-rating curriki-rating vertical-align"><span class="curriki-rating-title"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge">' . $resourceUser['reviewrating'] . '</span>'.$qtip_text.'</div>';
    } elseif ($resourceUser['reviewstatus'] == 'reviewed' && $resourceUser['reviewrating'] != null && $resourceUser['reviewrating'] < 0) {
        $qtip_text = '<div class="hidden-qtip">Commented</div>';
        $resource_header .= '<div class="resource-header-curriki-rating curriki-rating vertical-align"><span class="curriki-rating-title"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge">-</span>'.$qtip_text.'</div>';
    } elseif ($resourceUser['partner'] == 'T') {
        $qtip_text = '<div class="hidden-qtip"><strong>\'P\'</strong> - This is a trusted Partner resource</div>';
        $resource_header .= '<div class="resource-header-curriki-rating curriki-rating vertical-align"><span class="curriki-rating-title"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge">P</span>'.$qtip_text.'</div>';
    } else {
        $qtip_text = '<div class="hidden-qtip"><strong>\'NR\'</strong> - This resource has not been rated</div>';
        $resource_header .= '<div class="resource-header-curriki-rating curriki-rating vertical-align"><span class="curriki-rating-title"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge">NR</span>'.$qtip_text.'</div>';
        $do_nominate = true;
    }
  }
  ...
  if (!isset($_GET['viewer'])) {
    $resource_header .=
        ...
        <div class="grid_8 center">
            <div style="margin: 0 auto;"> <p id="msg_para"> The resource has been added to your collection </p> </div>
...
function curriki_resource_page_body() {
  ...
  if (!isset($_GET['viewer'])) {
    ...
    $information_tab .= '<div class="information-section">';
    $information_tab .= '<h4 class="resource-subheadline">Collections:</h4>';
    ...
    foreach ($resource['collections_resource_blogngs_to'] as $collection_of_resource) {
      $information_tab .= '<a class="href-cls" href="' . site_url() . "/oer/" . $collection_of_resource->pageurl . '" target="_blank">' . $collection_of_resource->title . '</a>' . "<br />";
    }
    $information_tab .= '</div>';
    ...
    $qtip_text = "";
    if ($resource['reviewstatus'] == 'reviewed' && $resource['reviewrating'] != null && $resource['reviewrating'] >= 0) {
        ...
        $reviews_tab .= '<div class="review-aggregate curriki-rating"><span class="curriki-rating"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge">' . $resource['reviewrating'] . '</span>'.$qtip_text.'</div>';
    } elseif ($resource['reviewstatus'] == 'reviewed' && $resource['reviewrating'] != null && $resource['reviewrating'] < 0) {
        $qtip_text = '<div class="hidden-qtip">Commented</div>';
        $reviews_tab .= '<div class="review-aggregate curriki-rating"><span class="curriki-rating"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge"> - </span>'.$qtip_text.'</div>';
    } elseif ($resource['partner'] == 'T') {
        $qtip_text = '<div class="hidden-qtip"><strong>\'P\'</strong> - This is a trusted Partner resource</div>';
        $reviews_tab .= '<div class="review-aggregate curriki-rating"><span class="curriki-rating"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge"> P </span>'.$qtip_text.'</div>';
    } else {
        $qtip_text = '<div class="hidden-qtip"><strong>\'NR\'</strong> - This resource has not been rated</div>';
        $reviews_tab .= '<div class="review-aggregate curriki-rating"><span class="curriki-rating"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span><span class="rating-badge"> NR </span>'.$qtip_text.'</div>';
    }
    ...
    $member_rating_display = (is_user_logged_in()) ? ('Member Rating ' . $stars) : ("");
    ...
    if (is_user_logged_in()) {
      ...
      if (isset($resource['currentUser']['uniqueavatarfile']))
        $reviews_tab .= '<img class="border-grey circle" src="https://' . DBI_AWS_S3_CDN_URL . '//avatars/' . $resource['currentUser']['uniqueavatarfile'] . '" alt="member-name" />';
      else
    ...
    $reviews_tab .= count($resource['comments']) == 0 && !is_user_logged_in() ? "<p>Not Rated Yet.</p>" : "";
  ...
  //**************** Start Side Bar ****************//  
  if (!isset($_GET['viewer']) && (count($resource["toc_persist"]) > 0 || count($resource['collection']) > 0) ) {
      ...
      if ((isset($resource['collection']) && count($resource['collection']) > 0) || $table_of_content->main_resource_resources["collections"] > 0) {
        ...
        if ($table_of_content->main_resource_resources["collections"] > 0) {
          ...
          foreach ($table_of_content->main_resource_resources["collections"] as $collection) {
            ...
            $resource_content .= '<li class="toc-file toc-image"><span class="fa fa-li fa-file-o"></span> <a href="' . $url_toc . '">' . stripslashes($collection['title']) . '</a></li>';
          }
          $resource_content .= '</ul>';
  ...
  $content = stripslashes((empty($resource['content'])) ? $resource['description'] : $resource['content']);
  ...
  if ($resource['type'] == 'collection' && isset($resource['collection'])) {
    ...
    foreach ($resource['collection'] AS $collection) {
      ...
      $resource_content .= '<div class="resource-content-content rounded-borders-full border-grey"><div class="collection-body-title"><div class="collection-title"><h3><a href="' . $url . '">' . stripslashes($collection['title']) . '</a></h3> by <span class="member-name name">' . $collection['contributorid_Name'] . '</span></div></div><div class="collection-body-content"><div class="collection-description">' . stripslashes($content) . '</div><div class="collection-rating rating"><span class="member-rating-title">Member Rating</span>' . $m_stars . '<a href="#">Rate this collection</a></div><div class="collection-curriki-rating curriki-rating">';
      ...
      if ($collection['reviewstatus'] == 'reviewed' && $collection['reviewrating'] != null && $collection['reviewrating'] >= 0) {
        ...
        $resource_content .= '<span class="curriki-rating-title"> <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span> <span class="rating-badge">' . $collection['reviewrating'] . '</span>'.$qtip_text.'';
      } elseif ($collection['reviewstatus'] == 'reviewed' && $collection['reviewrating'] != null && $collection['reviewrating'] < 0) {
          $qtip_text = '<div class="hidden-qtip">Commented</div>';
        $resource_content .= '<span class="curriki-rating-title">  <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span </span> </span><span class="rating-badge">-</span>'.$qtip_text.'';
      } elseif ($collection['partner'] == 'T') {
          $qtip_text = '<div class="hidden-qtip"><strong>\'P\'</strong> - This is a trusted Partner resource</div>';
        $resource_content .= '<span class="curriki-rating-title">  <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span> </span><span class="rating-badge">P</span>'.$qtip_text.'';
      } else {
          $qtip_text = '<div class="hidden-qtip"><strong>\'NR\'</strong> - This resource has not been rated</div>';
        $resource_content .= '<span class="curriki-rating-title">  <span class="curriki-rating-title-text tooltip-rating">Curriki Rating</span>'.$qtip_text.' </span> </span><span class="rating-badge">NR</span>'.$qtip_text.'';
      }
  ...
  $resource_content .= '
    <div style="display:none;"> 
      <div id="gc-widget-div"> 
        <div class="g-sharetoclassroom" data-url="' . $rs_url . '" data-title="' . stripslashes($resource['title']) . '" ></div> 
      </div> 
    </div>
  ...
  if (!empty($resource) and is_array($resource)) {
    echo '
      <div style="display:none;">
        ...
        <meta itemprop="name" value="' . stripslashes($resource['title']) . '"/>
  ...
  if (isset($resource['currentUser']['uniqueavatarfile']) && strlen($resource['currentUser']['uniqueavatarfile']) > 0)
    $display_image = '<img class="border-grey circle" src="https://' . DBI_AWS_S3_CDN_URL . '//avatars/' . $resource['currentUser']['uniqueavatarfile'] . '" alt="member-name" />';
  else
                ...
                <div class="review-content">
                            <div class="review-rating rating">
                                ...
                                <span>
                                    ...
                                    <button class="green-button">Submit Review</button>
                                    </form>
                 </div>
            </div>
    </div>
