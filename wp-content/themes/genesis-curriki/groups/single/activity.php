<div class="item-list-tabs no-ajax" id="bpsubnav" role="navigation">
	<ul>
                <?php
                    ...
                    {
                ?>
            <li class="feed"><a href="<?php bp_group_activity_feed_link(); ?>" title="<?php _e( 'RSS', 'buddypress' ); ?>"><img src="<?php echo get_bloginfo('stylesheet_directory');?>/images/rss.png" alt="" class="rss-img-top" /><?php _e( 'RSS', 'buddypress' ); ?></a></li>
                <?php }else{ ?>
