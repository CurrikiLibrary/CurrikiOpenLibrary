...
//                                                        $userinfo = $wpdb->get_row($q_userinfo);
                                                        ...
                                                        if(empty($userinfo->uniqueavatarfile)){
                                                            ...
                                                            echo '<img width="150" height="150" alt="Profile picture of '.$userinfo->full_name.'" class="avatar user-'.$userinfo->uniqueavatarfile.'-avatar avatar-'.$userinfo->uniqueavatarfile.' photo" src="https://' . DBI_AWS_S3_CDN_URL . '//avatars/'.$userinfo->uniqueavatarfile.'">';
                                                        }                                                        
                                                ?>
