...
class ES_Install {
	...
	public static function create_and_send_default_broadcast() {
		...
		$sample .= ' </ol>';
		$sample .= ' <strong>Thanks & Regards,</strong><br>The Curriki Team';
	...
	public static function create_and_send_default_post_notification() {
		...
		$content = "Hello {{NAME}},\r\n\r\n";
		$content .= "Here is the latest blog post from Curriki. {{POSTTITLE}}\r\n";
		$content .= "{{POSTIMAGE}}\r\n\r\n";
		$content .= "You can view it from this link : ";
		$content .= "{{POSTLINK}}\r\n\r\n";
		$content .= "Thanks!\r\n";
		$content .= "Your Curriki Team\r\n\r\n";
		$content .= "P.S. Be the first to know about new lessons, videos, teacher tips, and curriculum. <a href='https://www.curriki.org/curriki-newsletter-sign-up-2'>Sign-up to receive our newsletter.</a>";
